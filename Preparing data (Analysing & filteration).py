...
with open('/Users/asher/Documents/Project Stock predictions/data/djia_data.csv', 'rb') as csvfile:
...
for year in years:
    for month in months:
        file_str = '/Users/asher/Documents/Project Stock predictions/data/nytimes/' + str(year) + '-' + '{:02}'.format(month) + '.json'
...
#filtered_data.to_pickle('/Users/asher /Documents/Project Stock predictions/data/pickled_ten_year_all.pkl')  


# Saving the data as pickle file
interpolated_df.to_pickle('/Users/asher/Documents/Project Stock predictions/data/pickled_ten_year_filtered_lead_para.pkl')  


# Save pandas frame in csv form
interpolated_df.to_csv('/Users/asher/Documents/Project Stock predictions/data/sample_interpolated_df_10_years_filtered_lead_para.csv',
                       sep='\t', encoding='utf-8')



# Reading the data as pickle file
dataframe_read = pd.read_pickle('/Users/asher/Documents/Project Stock predictions/data/pickled_ten_year_filtered_lead_para.pkl')
